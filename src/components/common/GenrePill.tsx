import { GenreState, useMovieGenresStore, useTvGenresStore } from "@/store/genreListStore"
import { useSelectedMovieGenreStore, useSelectedTvGenreStore } from "@/store/selectedGenresStore";
...
const GenrePill = ({ genre, type }: Props) => {
  ...
  return (
    <Box
      ...
      className={genre.selected ? "bg-purple-900" : "bg-gray-900"}
      onClick={handleClick}
