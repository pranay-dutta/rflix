...
export const useHomeData = () => {
  ...
  const reels = useMemo(
    () => [
      { heading: "Trending Movies Today", media: trendingMoviesDay.data?.results },
      { heading: "Popular Movies", media: popularMovies.data?.pages[0].results },
      { heading: "Trending Movies This Week", media: trendingMoviesWeek.data?.results },
      { heading: "Top Rated Movies", media: topMovies.data?.pages[0].results },
      { heading: "Now Playing Movies", media: nowPlayingMovies.data?.pages[0].results },
      { heading: "Trending TV Shows Today", media: trendingShowsDay.data?.results },
      { heading: "Top TV Shows", media: topShows.data?.pages[0].results },
      { heading: "Trending TV Shows This Week", media: trendingShowsWeek.data?.results },
      { heading: "Popular TV Shows", media: popularShows.data?.pages[0].results },
      { heading: "On The Air TV Shows", media: onTheAirTvShows.data?.pages[0].results },
      {
